package ro.moonlighttm.monder.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Monder@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Monder API";

        private String description = "Monder API documentation";
